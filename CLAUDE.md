...
- `npx vite build` succeeds and emits a **1,760.57 kB** main chunk (470.17 kB gz), plus two
  lazy fertilizer chunks: **22.50 kB** `FertilizerContractsTab` (6.30 gz) and **11.48 kB**
  ...
  6.50 kB to the lazy one; F-5 added 4.58 kB to the main chunk, which is the eager
  Shopping Lists tab's share of the handoff.
- `npm test` reports **255 passing** in 6 files.
